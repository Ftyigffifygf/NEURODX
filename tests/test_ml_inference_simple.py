"""
Simplified unit tests for MONAI ML inference service components.

Tests core functionality without requiring full configuration setup.
"""
...
# Test the core model components without full settings
def test_swin_unetr_config_validation():
    """Test SwinUNETR configuration validation."""
    # Import locally to avoid settings issues
    from src.services.ml_inference.swin_unetr_model import SwinUNETRConfig
...
def test_multi_task_swin_unetr_model():
    """Test MultiTaskSwinUNETR model creation and forward pass."""
    from src.services.ml_inference.swin_unetr_model import SwinUNETRConfig, MultiTaskSwinUNETR
...
def test_model_manager_basic_functionality():
    """Test ModelManager basic functionality without full settings."""
    from src.services.ml_inference.swin_unetr_model import SwinUNETRConfig, ModelManager
    ...
    try:
        ...
        with patch('src.services.ml_inference.swin_unetr_model.get_settings') as mock_settings:
            ...
            new_manager = ModelManager(config, device=torch.device("cpu"))
            with patch('src.services.ml_inference.swin_unetr_model.get_settings') as mock_settings2:
                mock_settings2.return_value.monai.model_cache = temp_dir
...
def test_loss_function():
    """Test LossFunction calculation."""
    from src.services.ml_inference.training_orchestrator import LossFunction
    ...
    seg_output = torch.randn(batch_size, 3, 64, 64, 64, requires_grad=True)
    ...
    seg_target = torch.randint(0, 3, (batch_size, 1, 64, 64, 64))
...
def test_metrics_calculator():
    ...
    from src.services.ml_inference.training_orchestrator import MetricsCalculator
...
def test_training_config():
    ...
    from src.services.ml_inference.training_orchestrator import TrainingConfig
...
def test_training_metrics():
    ...
    from src.services.ml_inference.training_orchestrator import TrainingMetrics
...
def test_inference_request_and_result():
    """Test InferenceRequest and InferenceResult classes."""
    from src.services.ml_inference.inference_engine import InferenceRequest, InferenceResult
...
def test_confidence_calculator():
    ...
    from src.services.ml_inference.inference_engine import ConfidenceCalculator
